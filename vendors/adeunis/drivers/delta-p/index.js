...
(function (codec) {
    var Deltap0x11Parser = (function () {
        ...
        Deltap0x11Parser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            appContent['numberOfHistorizationBeforeSending'] = readUInt16BE(payload, 6);
            appContent['numberOfSamplingBeforeHistorization'] = readUInt16BE(payload, 2);
            appContent['samplingPeriod'] = { 'unit': 's', 'value': readUInt16BE(payload, 4) * 2 };
            appContent['calculatedPeriodRecording'] = { 'unit': 's',
                'value': readUInt16BE(payload, 2) * readUInt16BE(payload, 4) * 2 };
            appContent['calculatedSendingPeriod'] = { 'unit': 's',
                'value': readUInt16BE(payload, 2) * readUInt16BE(payload, 4) * readUInt16BE(payload, 6) * 2 };
            return appContent;
        };
    ...
    var Deltap0x53Parser = (function () {
        ...
        Deltap0x53Parser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            for (var offset = 2; offset < payload.length; offset += 2) {
                pressures.push(readInt16BE(payload, offset));
            }
...
(function (codec) {
    var Deltap0x54Parser = (function () {
        ...
        Deltap0x54Parser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            appContent['alarmStatus'] = readUInt8(payload, 2) ? 'active' : 'inactive';
            appContent['deltaPressure'] = { 'unit': 'pa', 'value': readInt16BE(payload, 3) };
            return appContent;
        };
...
(function (codec) {
    var Deltap0x55Parser = (function () {
        ...
        Deltap0x55Parser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            var voltages = [];
            for (var offset = 2; offset < payload.length; offset += 2) {
                voltages.push(readInt16BE(payload, offset));
            }
            appContent['decodingInfo'] = 'values: [t=0, t-1, t-2, ...]';
...
(function (codec) {
    var Deltap0x56Parser = (function () {
        ...
        Deltap0x56Parser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            appContent['alarmStatus'] = readUInt8(payload, 2) ? 'active' : 'inactive';
            appContent['voltage'] = { 'unit': 'mV', 'value': readInt16BE(payload, 3) };
            return appContent;
        };
