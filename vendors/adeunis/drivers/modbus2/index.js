...
***********************This driver is written according to the documentation of the MODBUS_V2_LORAWAN v2.0.0 attached in the specification********************************
...
const PERIODIC_DATA_1_FRAME = 0x44;
const PERIODIC_DATA_2_FRAME = 0x5f;
const PERIODIC_DATA_3_FRAME = 0x60;
const PERIODIC_DATA_4_FRAME = 0x61;
const PERIODIC_DATA_5_FRAME = 0x62;
const PERIODIC_DATA_6_FRAME = 0x63;
const ALARM_FRAME = 0x45;
const RESPONSE_FRAME_OF_READ_MODBUS_REGISTER = 0x5e;
const ACKNOWLEDGMENT_ON_WRITE_REGISTER = 0x2f;
...
const REQUEST_FRAME_FOR_READING_MODBUS_REGISTERS = 0x05;
const REQUEST_FRAME_FOR_WRITING_MODBUS_REGISTERS = 0x08;
...
const TRANSMISSION_PERIOD_OF_PERIODIC_DATA_1 = 0x01;
...
const TRANSMISSION_PERIOD_OF_PERIODIC_DATA_2 = 0x17;
const TRANSMISSION_PERIOD_OF_PERIODIC_DATA_3 = 0x18;
const TRANSMISSION_PERIOD_OF_PERIODIC_DATA_4 = 0x19;
const TRANSMISSION_PERIOD_OF_PERIODIC_DATA_5 = 0x1a;
const TRANSMISSION_PERIOD_OF_PERIODIC_DATA_6 = 0x1b;
const ALARM_REPETITION_PERIOD = 0x1d;
...
const uplinkPeriodicData1Type = "PERIODIC_DATA_1_FRAME";
const uplinkPeriodicData2Type = "PERIODIC_DATA_2_FRAME";
const uplinkPeriodicData3Type = "PERIODIC_DATA_3_FRAME";
const uplinkPeriodicData4Type = "PERIODIC_DATA_4_FRAME";
const uplinkPeriodicData5Type = "PERIODIC_DATA_5_FRAME";
const uplinkPeriodicData6Type = "PERIODIC_DATA_6_FRAME";
const uplinkAlarmType = "ALARM_FRAME";
const uplinkReadModbusRegisterType = "RESPONSE_OF_READ_MODBUS_REGISTER";
const uplinkAcknowledgmentType = "ACKNOWLEDGMENT_OF_WRITE_REGISTER";
...
const transmissionPeriodOfPeriodicData1Str = "TRANSMISSION_PERIOD_OF_PERIODIC_DATA_1";
...
const transmissionPeriodOfPeriodicData2Str = "TRANSMISSION_PERIOD_OF_PERIODIC_DATA_2";
const transmissionPeriodOfPeriodicData3Str = "TRANSMISSION_PERIOD_OF_PERIODIC_DATA_3";
const transmissionPeriodOfPeriodicData4Str = "TRANSMISSION_PERIOD_OF_PERIODIC_DATA_4";
const transmissionPeriodOfPeriodicData5Str = "TRANSMISSION_PERIOD_OF_PERIODIC_DATA_5";
const transmissionPeriodOfPeriodicData6Str = "TRANSMISSION_PERIOD_OF_PERIODIC_DATA_6";
...
downlinkMessageMap.set(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_1, transmissionPeriodOfPeriodicData1Str);
...
downlinkMessageMap.set(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_2, transmissionPeriodOfPeriodicData2Str);
downlinkMessageMap.set(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_3, transmissionPeriodOfPeriodicData3Str);
downlinkMessageMap.set(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_4, transmissionPeriodOfPeriodicData4Str);
downlinkMessageMap.set(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_5, transmissionPeriodOfPeriodicData5Str);
downlinkMessageMap.set(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_6, transmissionPeriodOfPeriodicData6Str);
...
//  mapping the request status of the modbus Acknowledgment for decoding
function getAcknowledgmentRequestStatus(value) {
    switch (value) {
        case 0x01:
            return successStr;
        case 0x02:
            return errorGenericStr;
        case 0x04:
            return errorInvalidRequestStr;
    }
}
...
function decodeUplink(input) {
    ...
    switch (code) {
        case PRODUCT_CONFIGURATION:
            ...
            result.register.transmissionPeriodOfPeriodicData1 = hexToDec(payloadHex, 8, 12) * 10;
            result.register.samplingPeriod = hexToDec(payloadHex, 12, 16) * 10;
        ...
        case NETWORK_CONFIGURATION:
            ...
            result.register.lorawanOptions.dutyCycle = ((option >> 2) & 0x01) == 1;
            result.register.lorawanOptions.type = getLorawanClass((option >> 5) & 0x01);
        ...
        case PERIODIC_DATA_2_FRAME:
            if (nbBytes > 50) {
                throw new Error(uplinkLengthError);
            }
            result.type = uplinkPeriodicData2Type;
            result.register = {};
        ...
        case PERIODIC_DATA_3_FRAME:
            if (nbBytes > 50) {
                throw new Error(uplinkLengthError);
            }
            result.type = uplinkPeriodicData3Type;
            result.register = {};
        ...
        case PERIODIC_DATA_4_FRAME:
            if (nbBytes > 50) {
                throw new Error(uplinkLengthError);
            }
            result.type = uplinkPeriodicData4Type;
            result.register = {};
        ...
        case PERIODIC_DATA_5_FRAME:
            if (nbBytes > 50) {
                throw new Error(uplinkLengthError);
            }
            result.type = uplinkPeriodicData5Type;
            result.register = {};
        ...
        case PERIODIC_DATA_6_FRAME:
            if (nbBytes > 50) {
                throw new Error(uplinkLengthError);
            }
            result.type = uplinkPeriodicData6Type;
            result.register = {};
        ...
        case ALARM_FRAME:
            if (nbBytes != 10 && nbBytes != 8) {
                throw new Error(uplinkLengthError);
            }
            result.type = uplinkAlarmType;
            result.register = {};

            result.register.alarmStatus = getAlarmStatus(hexToDec(payloadHex, 4, 6));
            result.register.modbusSlaveAddress = hexToDec(payloadHex, 6, 8);
            result.register.modbusRegisterAddress = hexToDec(payloadHex, 8, 12);
            result.register.valueOfModbusRegister1 = hexToDec(payloadHex, 12, 16);
            if (nbBytes == 10) {
                result.register.valueOfModbusRegister2 = hexToDec(payloadHex, 16, 20);
            }
            break;

        case RESPONSE_FRAME_OF_READ_MODBUS_REGISTER:
            if (nbBytes > 50) {
                throw new Error(uplinkLengthError);
            }
            result.type = uplinkReadModbusRegisterType;
            result.register = {};
        ...
        case ACKNOWLEDGMENT_ON_WRITE_REGISTER:
            if (nbBytes != 4) {
                throw new Error(uplinkLengthError);
            }
            result.type = uplinkAcknowledgmentType;
            result.register = {};

            result.register.downlinkFrameCodeAcknowledgment = hexToDec(payloadHex, 4, 6);
            result.register.requestStatus = getAcknowledgmentRequestStatus(hexToDec(payloadHex, 6, 8));
            break;
...
function decodeDownlink(input) {
    ...
    switch (type) {
        ...
        case REQUEST_FRAME_FOR_READING_MODBUS_REGISTERS:
            if (nbBytes != 6) {
                throw new Error(downlinkLengthError);
            }
            result.type = "REQUEST_FRAME_FOR_READING_MODBUS_REGISTERS";
            result.payload = {};
            result.payload.type = "ModbusFrameForReadingModbusRegisters";
            result.payload.register = {};
            result.payload.register.slaveAddress = hexToDec(payloadHex, 2, 4);
            result.payload.register.modbusRegisterType = getRegisterType(hexToDec(payloadHex, 4, 6));
            result.payload.register.firstRegisterAddress = hexToDec(payloadHex, 6, 10);
            result.payload.register.numberOfRegistersToRead = hexToDec(payloadHex, 10, 12);
            break;

        case REQUEST_FRAME_FOR_WRITING_MODBUS_REGISTERS:
            result.type = "REQUEST_FRAME_FOR_WRITING_MODBUS_REGISTERS";
            result.payload = {};
            result.payload.type = "ModbusFrameForWritingModbusRegisters";
            result.payload.register = {};
            result.payload.register.slaveAddress = hexToDec(payloadHex, 2, 4);
            result.payload.register.firstRegisterAddress = hexToDec(payloadHex, 4, 8);
            result.payload.register.numberOfRegistersToWrite = hexToDec(payloadHex, 8, 10);
            result.payload.register.modbusRegisters = [];
            for (let i = 10; i < payloadHex.length; i += 4) {
                let readings = {};
                readings.numberOfRegister = (i - 10) / 4 + 1;
                readings.value = hexToDec(payloadHex, i, i + 4);
                result.payload.register.modbusRegisters.push(readings);
            }
        ...
        case FRAME_FOR_UPDATING_THE_VALUE_OF_SPECIFIC_REGISTERS:
            ...
            while (pos < payloadHex.length) {
                ...
                switch (confId) {
                    ...
                    case TRANSMISSION_PERIOD_OF_PERIODIC_DATA_1:
                        result.payload.register.transmissionPeriodOfPeriodicData1 = hexToDec(payloadHex, pos, pos + 4) * 10;
                        pos += 4;
                        break;
                    ...
                    case TRANSMISSION_PERIOD_OF_PERIODIC_DATA_2:
                        result.payload.register.transmissionPeriodOfPeriodicData2 = hexToDec(payloadHex, pos, pos + 4) * 10;
                        pos += 4;
                        break;

                    case TRANSMISSION_PERIOD_OF_PERIODIC_DATA_3:
                        result.payload.register.transmissionPeriodOfPeriodicData3 = hexToDec(payloadHex, pos, pos + 4) * 10;
                        pos += 4;
                        break;

                    case TRANSMISSION_PERIOD_OF_PERIODIC_DATA_4:
                        result.payload.register.transmissionPeriodOfPeriodicData4 = hexToDec(payloadHex, pos, pos + 4) * 10;
                        pos += 4;
                        break;

                    case TRANSMISSION_PERIOD_OF_PERIODIC_DATA_5:
                        result.payload.register.transmissionPeriodOfPeriodicData5 = hexToDec(payloadHex, pos, pos + 4) * 10;
                        pos += 4;
                        break;

                    case TRANSMISSION_PERIOD_OF_PERIODIC_DATA_6:
                        result.payload.register.transmissionPeriodOfPeriodicData6 = hexToDec(payloadHex, pos, pos + 4) * 10;
                        pos += 4;
                        break;
                    ...
                    case ALARM_CONFIGURATION_1:
                        result.payload.register.alarmConfiguration1 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;

                    case ALARM_CONFIGURATION_2:
                        result.payload.register.alarmConfiguration2 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;

                    case ALARM_CONFIGURATION_3:
                        result.payload.register.alarmConfiguration3 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;

                    case ALARM_CONFIGURATION_4:
                        result.payload.register.alarmConfiguration4 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;

                    case ALARM_CONFIGURATION_5:
                        result.payload.register.alarmConfiguration5 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;

                    case ALARM_CONFIGURATION_6:
                        result.payload.register.alarmConfiguration6 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;

                    case ALARM_CONFIGURATION_7:
                        result.payload.register.alarmConfiguration7 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;

                    case ALARM_CONFIGURATION_8:
                        result.payload.register.alarmConfiguration8 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;

                    case ALARM_CONFIGURATION_9:
                        result.payload.register.alarmConfiguration9 = readAlarmConfiguration(hexToDec(payloadHex, pos, pos + 8));
                        pos += 8;
                        break;
...
function encodeDownlink(input) {
    ...
    switch (input.type) {
        ...
        case "REQUEST_FRAME_FOR_READING_MODBUS_REGISTERS":
            bytes.push(REQUEST_FRAME_FOR_READING_MODBUS_REGISTERS);
            const payloadReadingRegisters = input.payload.register;
            bytes.push(decToBytes(payloadReadingRegisters.slaveAddress));
            bytes.push(encodeRegisterType(payloadReadingRegisters.modbusRegisterType));
            const firstRegisterAddressBytesReading = decToBytes(payloadReadingRegisters.firstRegisterAddress);
            while (firstRegisterAddressBytesReading.length < 2) {
                firstRegisterAddressBytesReading.unshift(0x00);
            }
            bytes.push(firstRegisterAddressBytesReading);
            bytes.push(decToBytes(payloadReadingRegisters.numberOfRegistersToRead));
            break;

        case "REQUEST_FRAME_FOR_WRITING_MODBUS_REGISTERS":
            bytes.push(REQUEST_FRAME_FOR_WRITING_MODBUS_REGISTERS);
            const payloadWritingRegisters = input.payload.register;
            bytes.push(decToBytes(payloadWritingRegisters.slaveAddress));
            const firstRegisterAddressBytesWriting = decToBytes(payloadWritingRegisters.firstRegisterAddress);
            while (firstRegisterAddressBytesWriting.length < 2) {
                firstRegisterAddressBytesWriting.unshift(0x00);
            }
            bytes.push(firstRegisterAddressBytesWriting);
            bytes.push(decToBytes(payloadWritingRegisters.numberOfRegistersToWrite));
            for (let i = 0; i < payloadWritingRegisters.modbusRegisters.length; i++) {
                const modbusRegistersValuesBytes = decToBytes(payloadWritingRegisters.modbusRegisters[i].value);
                while (modbusRegistersValuesBytes.length < 2) {
                    modbusRegistersValuesBytes.unshift(0x00);
                }
                bytes.push(modbusRegistersValuesBytes);
            }
            break;
        ...
        case "FRAME_FOR_UPDATING_THE_VALUE_OF_SPECIFIC_REGISTERS":
            ...
            if (payload.transmissionPeriodOfPeriodicData1 != null) {
                bytes.push(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_1);
            ...
            if (
                payload.modbusLinkConfiguration != null
            ) {
            ...
            if (payload.transmissionPeriodOfPeriodicData2 != null) {
                bytes.push(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_2);
                const toPush = decToBytes(payload.transmissionPeriodOfPeriodicData2 / 10);
                while (toPush.length < 2) {
                    toPush.unshift(0x00);
                }
                bytes.push(toPush);
            }
            if (payload.transmissionPeriodOfPeriodicData3 != null) {
                bytes.push(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_3);
                const toPush = decToBytes(payload.transmissionPeriodOfPeriodicData3 / 10);
                while (toPush.length < 2) {
                    toPush.unshift(0x00);
                }
                bytes.push(toPush);
            }
            if (payload.transmissionPeriodOfPeriodicData4 != null) {
                bytes.push(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_4);
                const toPush = decToBytes(payload.transmissionPeriodOfPeriodicData4 / 10);
                while (toPush.length < 2) {
                    toPush.unshift(0x00);
                }
                bytes.push(toPush);
            }
            if (payload.transmissionPeriodOfPeriodicData5 != null) {
                bytes.push(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_5);
                const toPush = decToBytes(payload.transmissionPeriodOfPeriodicData5 / 10);
                while (toPush.length < 2) {
                    toPush.unshift(0x00);
                }
                bytes.push(toPush);
            }
            if (payload.transmissionPeriodOfPeriodicData6 != null) {
                bytes.push(TRANSMISSION_PERIOD_OF_PERIODIC_DATA_6);
                const toPush = decToBytes(payload.transmissionPeriodOfPeriodicData6 / 10);
                while (toPush.length < 2) {
                    toPush.unshift(0x00);
                }
                bytes.push(toPush);
