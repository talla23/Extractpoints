    ...
    var Motion0x10Parser = (function () {
        ...
        Motion0x10Parser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            appContent['transmissionPeriodKeepAlive'] = { 'unit': 's', 'value': readUInt16BE(payload, 2) * 10 },
                ...
                appContent['presenceDetectorInhibition'] = { 'unit': 's', 'value': readUInt16BE(payload, 10) * 10 },
...
(function (codec) {
    var Motion0x4eParser = (function () {
        ...
        Motion0x4eParser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            appContent['globalCounterValue'] = readUInt16BE(payload, 2);
            for (var offset = 4; offset < payload.length; offset += 3) {
                counters.push(readInt16BE(payload, offset));
                luminosities.push(readUInt8(payload, offset + 2));
            }
    ...
    var Motion0x4fParser = (function () {
        ...
        Motion0x4fParser.prototype.parseFrame = function (payload, configuration, network) {
            ...
            appContent['alarmPresence'] = {
                'globalCounterValue': readUInt16BE(payload, 2),
                'counterValue': readUInt16BE(payload, 4),
            };
            return appContent;
        };
