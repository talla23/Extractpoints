function extractPoints(input) {
    ...
    let powerFactorIndex=0;
    if (input.message.powerFactorL1 != null) {
        result["powerFactor:"+powerFactorIndex++] = { unitId: "/", record: input.message.powerFactorL1,nature:"L1"};
    }
    if (input.message.powerFactorL2 != null) {
        result["powerFactor:"+powerFactorIndex++] = { unitId: "/", record: input.message.powerFactorL2,nature:"L2"};
    }
    if (input.message.powerFactorL3 != null) {
        result["powerFactor:"+powerFactorIndex++] = { unitId: "/", record: input.message.powerFactorL3,nature:"L3"};
    }
    ...
    if (input.message.activePowerL1 != null) {
        result["activePower:"+activePowerIndex++] = { unitId: "W", record: input.message.activePowerL1,nature:"L1"};
    }
    if (input.message.activePowerL2 != null) {
        result["activePower:"+activePowerIndex++] = { unitId: "W", record: input.message.activePowerL2,nature:"L2"};
    }
    if (input.message.activePowerL3 != null) {
        result["activePower:"+activePowerIndex++] = { unitId: "W", record: input.message.activePowerL3,nature:"L3"};
    }
    if (input.message.activePowerTotal != null) {
        result["activePower:"+activePowerIndex++] = { unitId: "W", record: input.message.activePowerTotal,nature:"Total"};
    }
