...
function decodeUplink(inputObject){
    ...
    switch(frameType){ //Frame type is determined through the first byte.
        case 17:
            ...
            result.data = {
                ...
                latitude: twosHexToDecimal(decimalToHex(((input[2]*16*16 + input[3])*16*16 + input[4])*16*16 + input[5]))/1000000, //"*16*16" is equivalent to "<< 8"
                longitude: twosHexToDecimal(decimalToHex(((input[6]*16*16 + input[7])*16*16 + input[8])*16*16 + input[9]))/1000000, //It is used to decompose and recompose several bytes into one decimal value.
        ...
        case 20:
            ...
            result.data = {
                ...
                settings: {
                    motionStateBit1: input[3] & 0b10000000 == 1, //Decomposing parameters according to each bit of the analysed byte.
