...
function postProcessAncienMR2(decoded,data){
    ...
    if(decoded.sigfox != undefined){
        ...
        const Tref = binaire.slice(0,20);
        const Delta1 =  binaire.slice(20,32);
        const Delta2 =  binaire.slice(32,44);
        const Delta3 =  binaire.slice(44,56);
        const Delta4 =  binaire.slice(56,68);
        const Delta5 =  binaire.slice(68,80);
